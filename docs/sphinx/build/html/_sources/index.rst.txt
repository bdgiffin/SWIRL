...
**Author**: `Brian Doran Giffin <https://github.com/bdgiffin>`_

* *Email*: `brian.giffin@okstate.edu <mailto:brian.giffin@okstate.edu>`_
...
The core functionality of SWIRL is written in C++, with a fully supported Python API.
