...
# sys.path.append("//wsl.localhost/Ubuntu/root/Research/SWIRL/install/package/")
...
def run_analysis():
    ...
    radial_wind =np.mean(vx)*math.cos(tor_angle) +np.mean(vy)*math.sin(tor_angle)
    ...
    print( max_abs_drift_x,  max_abs_drift_y )
